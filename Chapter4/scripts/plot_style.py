...
line_properties = {"colour": ["black", "orange","dodgerblue", "forestgreen"],
...
color3 = ["black", "orange","dodgerblue", "forestgreen", 
          "black", "orange","dodgerblue", "forestgreen"]
...
dashes3 = [[3, 0], [3, 0], [3, 0], [3, 0],
           [4, 4], [4, 4], [4, 4], [4, 4]] # SF crit
